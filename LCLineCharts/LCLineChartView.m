...
- (void)setDefaultValues {
    ...
    self.currentPosView.backgroundColor = [UIColor colorWithRed:0.5 green:0.5 blue:0.5 alpha:1.0];
...
- (void)showIndicatorForTouch:(UITouch *)touch {
    if(! self.infoView) {
        ...
        self.infoView.bgColor = [UIColor clearColor];
    ...
    [UIView animateWithDuration:0.1 animations:^{
        ...
        r.origin.y = closestPos.y + 15;
        r.size.height = self.bounds.size.height - closestPos.y - 4*PADDING;
        self.currentPosView.frame = r;
